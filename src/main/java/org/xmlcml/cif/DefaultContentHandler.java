 ...
 * </p>
 * <p>
 * This class is normally subclassed for particular strategies.
 * </p>
 * 
 */

public class DefaultContentHandler implements CIFContentHandler {
...
//	boolean checkDuplicates = true;
	 ...
	 */
	/**
	 * set flag to check for duplicate loops and items.
	 * 
	 * @param check
	 *            (default is true)
	 */
	...
	public Document startDocument() throws CIFException {
		outputString("Started parsing document");
		return null;
	}
	...
	public void endDocument() throws CIFException {
		outputString("Finished parsing document");
	}
	...
	public ParserMessage addItem(CIFItem item) throws CIFException {
		outputString("Adding item: " + item.getName() + S_SLASH
				+ item.getValue());
		return null;
	}
	 ...
	 * names + values) in the CIF document. CIF contains no explicit endLoop
	 * event, and addLoop must be explicitly generated by a CIF parser
	 * </p>
	 * 
	 * @param loop
	 *            to add
	...
	public void addLoop(CIFLoop loop) throws CIFException {
		outputString("Adding loop: " + loop.getNameList().size() + S_SLASH
				+ loop.getValueList().size());
	}
	...
	public void comments(String[] data) throws CIFException {
		outputString("Adding comments: " + data.length + " lines");
	}
	...
	public void comment(String data) throws CIFException {
		outputString("Adding comment: " + data);
	}
